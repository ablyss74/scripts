...
xfooter(){
	[[ $REPLY == f && ${#playlist[*]} != 0 ]] && echo "${RED}Shuffling Favorites: ${favs}${BLUE} (-:"
	[[ $REPLY == f && ${#playlist[*]} == 0 ]] && echo "${RED}Favorites: ${favs} is empty. Press \"s\" then \"a\" to add to favorites.${BLUE} (-:"
	[[ $REPLY == s ]] && echo "${RED}Shuffling All${BLUE} (-:"
	[[ $REPLY == a ]] && echo "${RED}Added to favorites: ${favs}${BLUE} (-:"	
	[[ $REPLY == d ]] && echo "${RED}Deleted from favorites: ${favs}${BLUE} (-:"
